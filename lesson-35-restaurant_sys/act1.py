# import tkinter for gui and ttk
import tkinter as tk
from tkinter import ttk , messagebox

# define the RestaurantOrderMangementApp class
class RestaurantOrderManagement:
    # Initalize the application
    def __init__(self,root):
        self.root = root # The main window of the loop
        self.root.title("Restaurant Management App") # Set the title of the window

        #  A dictionary to stoore the menu items and their priced
        self.menu_items ={
            "CHICKEN BRIYANI" : 3,
            "MEALS ": 2,
           " PERI PERI PASTA" : 1,
        ...
        self.menu_labels = {}  # To store references to mene item labels
